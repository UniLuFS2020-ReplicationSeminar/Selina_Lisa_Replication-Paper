...
subtitle: "The ideological nationalization of partisan subconstituencies in the American States (2018) by Devin Caughey · James Dunham · Christopher Warshaw"
...
```{r Word Count and Papaja Add-In, include=FALSE}
library(devtools)
library(papaja)
library(rmdfiltr)
library(markdown)
