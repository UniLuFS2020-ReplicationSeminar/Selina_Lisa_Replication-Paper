...
```{r filtering out presidents, eval=FALSE}
# Drop presidents
...
```{r check polarity and test graph, eval=FALSE}
...
![] (/Users/nhatnguyen/Desktop/Uni/FS20/MA Replication/LisaSelina_Replication/Selina_Lisa_Replication-Paper/Figs/Figure1_Senate_Ideal_Points.png) The original graph of the senate ideal points.
