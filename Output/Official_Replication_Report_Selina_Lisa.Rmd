...
Economic <- load(here::here("Data","senate-econ.RData"))
Social <- load(here::here("Data","senate-social.RData"))
Racial <- load(here::here("Data","senate-race.RData"))
```
...
ideals <- filter(ideals, congress < 134,
